...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            PDPU: ["Sem-6"],
            books: ["How to Unfuck Yourself", "Hitchhiker's Guide To The Galaxy"],
            skills: ["Front-end development", "System Administration", "Networking", "Linux", "Coding", "Security", "Server Administration"],
            projects: ["CloudsOfMana-personal-portfolio", "Discord Bots", "ZeroTier", "UPNP Virtual Lan", "Heroku and ZEET app deployments", "Discord Administrator", "Botnet"],
            interests: ["Software Engineering", "Deep Learning", "Quantum Computing"],
            languages: ["Javascript", "C++", "Java", "html5"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">clouds@mana</div>
