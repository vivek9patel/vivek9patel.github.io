...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            PDPU: ["Sem-6"],
            books: ["Busty Argonian Maid.ebook", "How To Be Nosy.pdf", "Goth Girld For Dummies.ebook", "How to Mind Your Own Business.pdf"],
            skills: ["Front-end development", "React.js", "jQuery", "Flutter", "Express.js", "SQL", "Firebase"],
            projects: ["Isle Of The Blessed", "Custom Bots", "", "Network Engineering", "Music Theory", "Server Development", "Remote Management"],
            interests: ["Software Engineering", "Deep Learning", "Computer Vision"],
            languages: ["Javascript", "Python", "React", "PowerShell"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">clouds@IOTB</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/IOTB")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-clouds, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-clouds":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-clouds");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-clouds, todoist, trash, settings, sendmsg ]";
                }
                break;
