    ...
    return (
        <>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                ...
                <li className=" mt-3 list-star"> Our purpose is to establish quality of individual and community life and well-being, not necessarily cessation of all drug us.</li>
            </ul>
        </>
    )
}
