        ...
        return (
            <>
                <div id="about" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "about" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="about IOTB" src="./themes/Yaru/status/about.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">About Me</span>
                </div>
                <div id="Our Mission" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "Our Mission" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="IOTB' Our Mission" src="./themes/Yaru/status/our_mission.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Our Mission</span>
                </div>
                <div id="Mental Health" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "Mental Health" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="IOTB' Mental Health" src="./themes/Yaru/status/Mental_Health.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Mental Health</span>
                </div>
                <div id="Peer Support" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "Peer Support" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="IOTBek' Peer Support" src="./themes/Yaru/status/Peer_Support.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Peer Support</span>
                </div>
                <div id="Harm Reduction" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "Harm Reduction" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="Harm Reduction" src="./themes/Yaru/status/Harm_Reduction.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Harm Reduction</span>
                </div>
                <div className='my-0.5 w-28 md:w-full h-8 px-2 md:px-2.5 flex' >
                    <iframe src="https://discord.gg/dBZGS2NQvW" title="Join IOTB" width={"100%"} height={"100%"} ></iframe>
                </div>
            </>
        );
    }
    ...
    return (
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img className="w-full" src="./images/logos/bitmoji.png" alt="Isle Of The Blessed Logo" />
            </div>
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">CloudsOfMana</span> ,</div>
                <div className="font-normal ml-1">Gaming, Harm Reduction, and Peer Support!</span></div>
            </div>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">We are a <span className=" font-medium">Harm Reduction community</span> looking to share resources for safe drug use and <u className=' cursor-pointer '> <a href="https://discord.gg/dBZGS2NQvW" target={"_blank"}>Peer Suport</a> </u>, while establishing a quality of individual and community life and well-being! ( Hit me up <a className='text-underline' href='mailto:support@isleoftheblessed.org'><u>@support@isleoftheblessed.org</u></a> :) )</li>
                <li className=" mt-3 list-building"> I enjoy building awesome softwares that solve practical problems.</li>
                <li className=" mt-3 list-time"> We Do not attempt to minimize or ignore the real and tragic harm and danger that can be associated with illicit drug use.</a></li>
            </ul>
        </>
    )
}
