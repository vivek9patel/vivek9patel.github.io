...
export class AboutClouds extends Component {
        ...
        return (
            <>
                ...
                <div id="projects" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "projects" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="hub" src="./themes/Yaru/status/projects.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Hub</span>
                </div>
                ...
                <div className='my-0.5 w-28 md:w-full h-8 px-2 md:px-2.5 flex' >
                    <iframe src="https://github.com/sponsors/vivek9patel/button" title="Sponsor Clouds" width={"100%"} height={"100%"} ></iframe>
                </div>
            </>
        );
    }
...
export const displayAboutClouds = () => {
    return <AboutVivek />;
}
    ...
    return (
        <>
            ...
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">Dominic Judy</span> ,</div>
                <div className="font-normal ml-1">I'm a <span className="text-pink-600 font-bold">Computer Engineer!</span></div>
            </div>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a <span className=" font-medium">Computer Engineer</span> from KS USA. College graduation in Computer Technology Networking and Administration. <u className=' cursor-pointer '> <a href="https://en.wikipedia.org/wiki/HackerRank" target={"_blank"}>HackerRank</a> </u></li>
                <li className=" mt-3 list-building"> I enjoy building awesome softwares that solve practical problems.</li>
                <li className=" mt-3 list-time"> When I am not coding or working on a project, I like to spend my time with my dogs, playing videogames or watching my favorite documentaries!
                <li className=" mt-3 list-star"> I also have interest playing music and composition!</li>
            </ul>
        </>
    )
}
